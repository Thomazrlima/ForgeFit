Feature: Cancelamento de reserva com política de reembolso
  ...
  Scenario: Cancelamento com reembolso total processado
    Given existe uma reserva confirmada para o aluno com matrícula "123.456.789-01" no dia "10/09/2025" às "10:00" com duração de "60 minutos"
  ...
  Scenario: Tentativa de cancelamento após prazo de reembolso total
    Given existe uma reserva confirmada para o aluno com matrícula "234.567.890-12" no dia "10/09/2025" às "10:00" com duração de "60 minutos"
  ...
  Scenario: Cancelamento com reembolso parcial processado
    Given existe uma reserva confirmada para o aluno com matrícula "345.678.901-23" no dia "15/09/2025" às "14:00" com duração de "90 minutos"
    When o aluno solicita o cancelamento em "10/09/2025"
    Then o sistema informa "cancelamento aprovado, reembolso parcial em processamento"

  Scenario: Tentativa de cancelamento fora do prazo parcial
    Given existe uma reserva confirmada para o aluno com matrícula "456.789.012-34" no dia "15/09/2025" às "14:00" com duração de "90 minutos"
  ...
  Scenario: Cancelamento fora do prazo sem reembolso
    Given existe uma reserva confirmada para o aluno com matrícula "567.890.123-45" no dia "12/09/2025" às "09:00" com duração de "120 minutos"
  ...
  Scenario: Cancelamento realizado com sucesso
    Given existe uma reserva confirmada para o aluno com matrícula "678.901.234-56" no dia "18/09/2025" às "11:00" com duração de "75 minutos"
    When o aluno solicita o cancelamento em "10/09/2025"
    Then o sistema informa "cancelamento aprovado, reembolso parcial em processamento"

  Scenario: Tentativa de cancelamento duplicado
    Given existe uma reserva confirmada para o aluno com matrícula "789.012.345-67" no dia "18/09/2025" às "11:00" com duração de "75 minutos"
  ...
  Scenario: Cancelamento realizado de uma reserva existente
    Given existe uma reserva confirmada para o aluno com matrícula "890.123.456-78" no dia "22/09/2025" às "15:00" com duração de "45 minutos"
    When o aluno solicita o cancelamento em "10/09/2025"
    Then o sistema informa "cancelamento aprovado, reembolso parcial em processamento"

  Scenario: Tentativa de cancelar reserva inexistente
    Given não existe reserva confirmada para o aluno com matrícula "901.234.567-89" na data "22/09/2025" às "15:00"
    When o aluno solicita o cancelamento em "10/09/2025"
    Then o sistema informa "nenhuma reserva encontrada para cancelamento"
