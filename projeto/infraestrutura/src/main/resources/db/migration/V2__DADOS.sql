...
INSERT INTO PROFESSOR(CPF, NOME, DATA_NASCIMENTO, USER_ID) VALUES 
    ...
    ('23456789012', 'Maria Santos', '1988-11-12', '5'),
    ('34567890123', 'Pedro Oliveira', '1990-03-20', '6'),
    ('45678901234', 'Julia Costa', '1992-08-25', '7'),
    ('56789012345', 'Ricardo Souza', '1987-04-18', '8');
...
INSERT INTO ALUNO(MATRICULA, CPF, NOME, DATA_NASCIMENTO, USER_ID, CREDITOS, PONTUACAO_TOTAL, STATUS) VALUES 
    ('ALU001', '11122233344', 'Pedro Aluno', '1995-09-10', '14', 100.00, 50, 'ATIVO'),
    ...
    ('ALU004', '44455566677', 'Mariana Lima', '1999-02-14', '17', 200.00, 180, 'ATIVO'),
    ('ALU005', '55566677788', 'Roberto Santos', '1996-05-30', '18', 50.00, 30, 'ATIVO');
...
INSERT INTO PLANO_TREINO(PLT_PROFESSOR_ID, DATA_CRIACAO, DATA_VALIDADE_SUGERIDA) VALUES 
    (1, '2025-01-01', '2025-04-01'),
    (2, '2025-01-01', '2025-04-01');

-- Treinos diários do Plano 1 (ABC)
INSERT INTO TREINO_DIARIO(PLT_ID, LETRA, TIPO) VALUES 
    (1, 'A', 'PEITO_E_TRICEPS'),
    (1, 'B', 'COSTAS_E_BICEPS'),
    (1, 'C', 'PERNAS');

-- Exercícios do Treino A
INSERT INTO ITEM_EXERCICIO(TRD_ID, POSICAO, EXERCICIO, SERIES, REPETICOES) VALUES 
...
VALUES 
    ('ALU001', 1, 15, 'Treino A concluído! Peito bombado!', 'TREINO', 1, 'A');
