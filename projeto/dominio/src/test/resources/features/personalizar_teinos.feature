...
# Conforme CML: Service TreinoService { @PlanoDeTreino criarPlanoDeTreino(...) }
# O CML especifica apenas a criação de planos completos com lista de treinos
#REGRA 1 - Criar plano de treino com dois treinos

  Scenario: Criação de plano de treino com treinos "A" e "B"
    Given o professor com CPF "123.456.789-01" seleciona o aluno com CPF "123.456.789-00"
...
#REGRA 2 - Criar plano com um único treino
  ...
  Scenario: Criar plano de treino com apenas treino "A"
    Given o aluno com CPF "123.456.789-00" não possui plano de treino ativo
    When o professor com CPF "123.456.789-01" cria um plano de treino com apenas treino "A" de corpo inteiro
...
#REGRA 3 - Criar plano completo com 7 treinos (limite máximo)
  ...
  Scenario: Criar plano de treino com todos os 7 dias da semana
    Given o aluno com CPF "123.456.789-00" necessita de um plano completo
    When o professor com CPF "123.456.789-01" cria um plano de treino com 7 treinos de "A" até "G"
...
#REGRA 4 - Validar limite máximo de 7 treinos
  ...
  Scenario: Tentar criar plano com 8 treinos (mais que o limite)
    Given o professor com CPF "123.456.789-01" está criando um plano para o aluno com CPF "123.456.789-00"
...
#REGRA 5 - Criar plano com validade sugerida
  ...
  Scenario: Criar plano de treino com data de validade sugerida
    Given o aluno com CPF "123.456.789-00" está iniciando um novo ciclo de treino
    When o professor com CPF "123.456.789-01" cria um plano de treino com validade sugerida de "90" dias
...
#REGRA 6 - Criar plano sem validade sugerida
  ...
  Scenario: Criar plano de treino sem data de validade
    Given o aluno com CPF "123.456.789-00" necessita de um plano permanente
    When o professor com CPF "123.456.789-01" cria um plano de treino sem validade sugerida
